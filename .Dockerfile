...
ADD ZITADEL_FIRSTINSTANCE_LOGINCLIENTPATPATH
ADD ZITADEL_FIRSTINSTANCE_ORG_HUMAN_PASSWORDCHANGEREQUIRED
ADD ZITADEL_FIRSTINSTANCE_ORG_LOGINCLIENT_MACHINE_USERNAME
ADD ZITADEL_FIRSTINSTANCE_ORG_LOGINCLIENT_MACHINE_NAME
ADD ZITADEL_FIRSTINSTANCE_ORG_LOGINCLIENT_PAT_EXPIRATIONDATE
ADD ZITADEL_DEFAULTINSTANCE_FEATURES_LOGINV2_REQUIRED
ADD ZITADEL_DEFAULTINSTANCE_FEATURES_LOGINV2_BASEURI
ADD ZITADEL_OIDC_DEFAULTLOGINURLV2
ADD ZITADEL_OIDC_DEFAULTLOGOUTURLV2
ADD ZITADEL_OIDC_DEFAULTERRORURLV2
...
ENV ZITADEL_FIRSTINSTANCE_LOGINCLIENTPATPATH=${ZITADEL_FIRSTINSTANCE_LOGINCLIENTPATPATH}
