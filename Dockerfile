# Main ZITADEL image - No builder stage needed!
...
ARG ZITADEL_FIRSTINSTANCE_ORG_LOGINCLIENT_CLIENTID
ARG ZITADEL_FIRSTINSTANCE_ORG_LOGINCLIENT_CLIENTSECRET
...
ENV ZITADEL_FIRSTINSTANCE_LOGINCLIENT_AUTHMETHOD="client_credentials"
ENV ZITADEL_FIRSTINSTANCE_LOGINCLIENT_CLIENTID=${ZITADEL_FIRSTINSTANCE_ORG_LOGINCLIENT_CLIENTID}
ENV ZITADEL_FIRSTINSTANCE_LOGINCLIENT_CLIENTSECRET=${ZITADEL_FIRSTINSTANCE_ORG_LOGINCLIENT_CLIENTSECRET}
...
# CMD will be set in Railway interface for flexibility